...
#'
#' Template for creating an R markdown document using the DSCOE-Modified Bulma CSS framework style
#'
...
#' date: "`r Sys.Date()`"
#' output: markdowntemplates::dscoe
#' ---}
#'
...
#' }
#' @export
dscoe <- function(number_sections = FALSE,
                  fig_width = 7,
                  fig_height = 5,
  ...
  dep <- htmltools::htmlDependency("bulmastyle", "0.0.10",
           system.file("rmarkdown", "templates", "dscoe", "resources",
  ...
  args <- c(args, "--template",
            rmarkdown::pandoc_path_arg(system.file("rmarkdown", "templates", "dscoe", "base.html",
                                                   package = "dscoemarkdown")))
